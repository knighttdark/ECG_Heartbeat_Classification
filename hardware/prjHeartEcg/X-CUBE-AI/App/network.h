...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "train_mitbih_cnn"
...
#define AI_NETWORK_IN_1_HEIGHT      (187)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (187)
#define AI_NETWORK_IN_1_SIZE_BYTES  (748)
